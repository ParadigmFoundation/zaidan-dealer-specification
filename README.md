...
-   Implementations MUST use Arrays for return values and parameters (in accordance with the JSONRPC specification).
...
-   Implementations MUST NOT operate on more than one Ethereum network (identified by the [chain ID](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-155.md)) at a time (see [note 2](#notes)).
-   Implementations MUST use the correct chain ID for the active Ethereum network, as specified in [EIP-155](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-155.md).
